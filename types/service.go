...
type BoardAutoTemplate struct {
	...
	Subtype                   ServiceSubType         `json:"subtype"`
...
type BoardSkillMapping struct {
	...
	SkillCategory SkillCategory          `json:"skillCategory"`
...
type BoardTeam struct {
	...
	TeamLeader            Member                 `json:"teamLeader"`
}
...
type KnowledgeBaseCategory struct {
	Info       map[string]interface{} `json:"_info,omitempty"`
	Approver   Member                 `json:"approver,omitempty"`
	Department SystemDepartment       `json:"department,omitempty"`
	ID         int                    `json:"id,omitempty"`
	Location   SystemLocation         `json:"location,omitempty"`
	Name       string                 `json:"name"`
...
type KnowledgeBaseSettings struct {
	Info            map[string]interface{} `json:"_info,omitempty"`
	DefaultApprover Member                 `json:"defaultApprover,omitempty"`
	ID              int                    `json:"id,omitempty"`
...
type SLA struct {
	...
	CustomCalendar      Calendar               `json:"customCalendar,omitempty"`
	DefaultFlag         bool                   `json:"defaultFlag,omitempty"`
	HiImpactHiUrgency   Priority               `json:"hiImpactHiUrgency,omitempty"`
	HiImpactLowUrgency  Priority               `json:"hiImpactLowUrgency,omitempty"`
	HiImpactMedUrgency  Priority               `json:"hiImpactMedUrgency,omitempty"`
	ID                  int                    `json:"id,omitempty"`
	LowImpactHiUrgency  Priority               `json:"lowImpactHiUrgency,omitempty"`
	LowImpactLowUrgency Priority               `json:"lowImpactLowUrgency,omitempty"`
	LowImpactMedUrgency Priority               `json:"lowImpactMedUrgency,omitempty"`
	MedImpactHiUrgency  Priority               `json:"medImpactHiUrgency,omitempty"`
	MedImpactLowUrgency Priority               `json:"medImpactLowUrgency,omitempty"`
	MedImpactMedUrgency Priority               `json:"medImpactMedUrgency,omitempty"`
	Name                string                 `json:"name"`
...
type ServiceSignoffCustomField struct {
	...
	UserDefinedField UserDefinedField       `json:"userDefinedField"`
}
...
type ServiceSurvey struct {
	...
	InactiveFlag          bool                   `json:"inactiveFlag,omitempty"`
	Name                  string                 `json:"name"`
	NotifyMember          Member                 `json:"notifyMember,omitempty"`
	NotifyWho             GenericIdentifier      `json:"notifyWho,omitempty"`
